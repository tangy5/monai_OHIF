...
cd extensions
ln -s ../../extensions/vista3d vista3d
cd ..

cd modes
ln -s ../../modes/vista3d vista3d
cd ..

git apply ../extensions.patch

cp ../config/vista3d.js platform/app/public/config/vista3d.js

yarn config set workspaces-experimental true
yarn install
APP_CONFIG=config/vista3d.js PUBLIC_URL=/ohif/ QUICK_BUILD=true yarn run build
